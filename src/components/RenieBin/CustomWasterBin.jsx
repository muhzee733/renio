    ...
    <section className="renie-licensee">
      <div className="renie-licensee-container">
        <div className="renie-licensee-left custom-design">
          ...
          <p className="desc">
            Have a unique type of waste you want to collect? Whether it’s coffee
            cups, sneakers, cooking oil, or electronics, we develop custom Renie
            Bins designed specifically for your collection needs. Our in-house
            engineering team adapts the hardware and software to support any
            waste stream, ensuring full integration with the Renie platform for
            tracking, impact reporting, and monetization.
          </p>
