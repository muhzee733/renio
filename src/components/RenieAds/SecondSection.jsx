...
const sections = [
  {
    title: `<span className="gradient-color">Optimizing </span> <span className="custom-color">ads delivery</span> <span className="gradient-color"> with AI-powered data from renie bins </span>`,
  ...
  {
    title: `<span className="gradient-color">Your brand, </span><span className="custom-color">fully customizable</span> <span className="gradient-color">on our platform</span>`,
  ...
  {
    title: `<span className="gradient-color">Make a lasting  ${"<br />"} </span> <span className="custom-color">first impression</span>`,
  ...
  {
    title: `<span className="gradient-color">Ads for ${"<br />"} every stage of your </span><span className="custom-color">marketing funnel</span>`,
  ...
  {
    title: `<span className="gradient-color">Visible in </span> <br/> <span className="custom-color">thousands of locations </span><span className="gradient-color">every day</span>`,
