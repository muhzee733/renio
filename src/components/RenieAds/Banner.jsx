          ...
          <div className="col-lg-6 custom-padding ">
            <div>
              ...
              <p className="text-muted">
                We enable impactful ads that empower both advertisers and users
                with value-driven engagement. Through our innovative AI-powered
                platform, we redefine the future of advertising where creativity
              ...
              <p className="text-white custom-ads-text">
                ...
                interactions, we deliver ads that are not only relevant but also
                impactful.
              </p>
            </div>
          </div>
